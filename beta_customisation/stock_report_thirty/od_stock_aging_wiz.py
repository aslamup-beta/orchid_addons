...
class od_stock_aging_report_wizard_30(orm.TransientModel):
    _name = "od.stock.aging.report.wizard.30"
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        return self.pool['report'].get_action(cr, uid, [], 'beta_customisation.report_stock_aging_30', data=data, context=context)

    def xls_export(self, cr, uid, ids, context=None):
        return self.print_report(cr, uid, ids, context=context)

od_stock_aging_report_wizard_30()
