...
#                         branch_managers.append(br_email)
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        if lead.od_partner_class in ('a','b') and uid != customer_am and uid not in (1,5,6,8,2137,101,154,268,2429,134,2663,2441,2536,2537,2660,2653,2664,2597,2260,2244,2445,2657,271,2467,2151,2700,2654):
    ...
    _columns = {
        ...
        'od_leading_solution_arc_id': fields.many2one('res.users', compute='_compute_leading_solution_arc_id',
                                                      string='Leading Solution Architect', select=True,
                                                      track_visibility='onchange',
