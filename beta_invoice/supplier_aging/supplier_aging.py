...
class BetaSupplierAgingWiz(models.TransientModel):
    _name='od.beta.supplier.aging.wiz'
    ...
    wiz_line = fields.One2many('od.beta.supplier.aging.data','wiz_id',string="Wiz Line")
    ...
    def _get_lines(self):
        ...
        for partner in partners:
            ...
            payment_term = part.property_supplier_payment_term and part.property_supplier_payment_term.id or ''
            custom_payment_term = part.x_custom_payment_term or ''
            values['payment_term_id'] = payment_term
            values['custom_payment_term'] = custom_payment_term
            res.append(values)
    ...
    def export_rpt(self):
        ...
        for val in values:
            result.append((0,0,{
                ...
                'custom_payment_term':val.get('custom_payment_term'),
        ...
        period_length = self.period_length
        vw ='od_supplier_aging_data_tree_view_1' 
        if period_length == 60:
            vw = 'od_supplier_aging_data_tree_view_2'
        ...
        return {
            ...
            'res_model': 'od.beta.supplier.aging.data',
            'type': 'ir.actions.act_window',
        }
    

class wiz_project_rpt_data(models.TransientModel):
    _name = 'od.beta.supplier.aging.data'
    wiz_id = fields.Many2one('od.beta.supplier.aging.wiz',string="Wizard")
    ...
    custom_payment_term = fields.Text(string="Custom Payment Term")
