...
class BetaCustomeAgingWizHigh(models.TransientModel):
    _name='od.beta.customer.aging.wiz.high'
    ...
    wiz_line = fields.One2many('od.beta.customer.aging.data.high','wiz_id',string="Wiz Line")
    ...
    def export_rpt(self):
        ...
        period_length = self.period_length
        vw ='od_customer_aging_data_tree_view_1_high' 
        if period_length == 60:
            vw = 'od_customer_aging_data_tree_view_2_high'
        ...
        return {
            ...
            'res_model': 'od.beta.customer.aging.data.high',
            'type': 'ir.actions.act_window',
        }
    

class wiz_project_rpt_data(models.TransientModel):
    _name = 'od.beta.customer.aging.data.high'
    
    
    
    wiz_id = fields.Many2one('od.beta.customer.aging.wiz.high',string="Wizard")
    ...
    open_bal = fields.Float(string="Open Balance")
    closed_bal = fields.Float(string="Closed Balance")
