...
class opp_rev_brand_rpt_ext_wiz(models.TransientModel):
    _name = 'opp.rev.brand.rpt.ext.wiz'
    ...
    wiz_line = fields.One2many('wiz.rev.brand.rpt.ext.data', 'wiz_id', string="Wiz Line")

    sm_ids = fields.Many2many('res.users', 'wiz_sale_a', 'wiz_id', 'user_id', string="Customer AM")
    lead_am_ids = fields.Many2many('res.users', 'wiz_lead_a4', 'wiz_id', 'user_id', string="Lead AM",
    ...
    def export_rpt(self):
        ...
        for sheet in cost_sheet_data:
            ...
            if product_brand_ids:
                fm_view = "od_rev_opp_tree_view_ext"
        ...
        return {
            ...
            'res_model': 'wiz.rev.brand.rpt.ext.data',
            'type': 'ir.actions.act_window',
        }


class wiz_rev_brand_rpt_ext(models.TransientModel):
    _name = 'wiz.rev.brand.rpt.ext.data'
    wiz_id = fields.Many2one('opp.rev.brand.rpt.ext.wiz', string="Wizard")
