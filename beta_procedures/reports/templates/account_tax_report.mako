    ...
    <body>
        ...
        <div class="act_as_table data_table">
            <div class="act_as_row labels">
                ...
                <div class="act_as_cell">${_('Accounts Filteraaaaaaaaa')}</div>
            ...
            <div class="act_as_table list_table" style="margin-top: 10px;">
                ...
                <div class="act_as_thead">
                    <div class="act_as_row labels">
                        ...
                        ## journal
                        <div class="act_as_cell" style="width: 400px;">${_('Journal')}</div>
                        ## account code
                        <div class="act_as_cell" style="width: 65px;">${_('Account')}</div>
                        ## partner
                        <div class="act_as_cell" style="width: 120px;">${_('Partner')}</div>
                        ## label
                        <div class="act_as_cell" style="width: 60px;">${_('Label')}</div>
                         ## label
                        <div class="act_as_cell" style="width: 60px;">${_('Analytic Account')}</div>
                        ## counterpart
                ...
                <div class="act_as_tbody">
                      ...
                      <div class="act_as_row lines">
                          ...
                          ## analytic name
                          <div class="act_as_cell">${line.get('analytic_name') or ''</div>
                          ## counterpart
