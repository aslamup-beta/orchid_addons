...
class JoiningTrainingVideos(models.Model):
    _name = 'joining.training.videos'
    _description = "JoiningTrainingVideos"


    name = fields.Char('Name')
    cs_training_1 = fields.Char('Internet and Social Media Security')
    cs_training_2 = fields.Char('Cybersecurity Acceptable Use Policy')
    cs_training_3 = fields.Char('Social Engineering and Phishing Emails')
    cs_training_4 = fields.Char('Credential Sharing')
    cs_training_5 = fields.Char('Data Security')
    cs_training_6 = fields.Char('Mobile Security')
    cs_training_7 = fields.Char('Company Policies and Regulations')
    cs_training_8 = fields.Char('Work Systems and Internal Tools')
