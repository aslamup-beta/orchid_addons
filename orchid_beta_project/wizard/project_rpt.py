...
class wiz_project_rpt_data(models.TransientModel):
    ...
    contract_status = fields.Selection([('template','Template'),('draft','New'),('open','In Progress'),('pending','To Renew'),('close','Closed'),('sign_off','Sign Off'),('cancelled','Cancelled')],string="Contract Status")
