...
# 			'views/od_project_changes.xml',
			...
			'wizard/supply_chain_rpt_view.xml',
			'wizard/sales_commit_rpt_view.xml',
			'wizard/project_mat_iss_view.xml',
			'wizard/proc_wiz_view.xml',
			'wizard/inv_wiz_view.xml',
			'manhour/manhour_rpt_view.xml',
			'data/data.xml',
            'analytic_view.xml',
            'invoice_view.xml',
            ...
            'hr_expense/audit_template_view.xml',
             ...
             'certificate/sales_enablement.xml',
             'certificate/sale_certificate_view.xml',
              'certificate/engineer_certificate_view.xml',
              'certificate/mail_template.xml',
			],
	'demo': [],
	'test': [],
	'installable': True,
