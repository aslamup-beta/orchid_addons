...
#
#    Copyright (c) 2014 Noviat nv/sa (www.orchidiat.com). All rights reserved.
#
...
class account_print_journal_xls(orm.TransientModel):
    ...
    _columns = {
        'journal_ids': fields.many2many('account.journal', 'account_print_journal_journal_rel11', 'account_id11', 'journal_id11', 'Journals', required=True),
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        if context.get('xls_export'):
            return {'type': 'ir.actions.report.xml',
                    'report_name': 'orchid.account.journal.xls',
                    'datas': datas}
        else:
            return {
                'type': 'ir.actions.report.xml',
                'report_name': 'orchid.account.journal.print',
                'datas': datas}
